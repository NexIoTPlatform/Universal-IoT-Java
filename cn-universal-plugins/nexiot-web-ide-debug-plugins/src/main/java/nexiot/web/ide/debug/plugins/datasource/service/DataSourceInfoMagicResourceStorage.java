...
public class DataSourceInfoMagicResourceStorage
    implements MagicResourceStorage<DataSourceInfo>, JsonCodeConstants {
  ...
  public void validate(DataSourceInfo entity) {
    ...
    boolean noneMatchKey =
        magicResourceService.listFiles("datasource:0").stream()
