package nexiot.web.ide.debug.plugins.modules.servlet;
...
public class ResponseModule {
  ...
  public static ResponseEntity<?> download(
      @Comment(name = "value", value = "文件内容，如`byte[]`") Object value,
  ...
  @Comment("返回自定义分页结果")
  public Object page(
      @Comment(name = "total", value = "总条数") long total,
  ...
  public ResponseEntity image(
      @Comment(name = "value", value = "图片内容，如`byte[]`") Object value,
