...
import nexiot.web.ide.debug.plugins.modules.db.mybatis.MybatisParser;
import nexiot.web.ide.debug.plugins.modules.db.mybatis.SqlNode;
import nexiot.web.ide.debug.plugins.modules.db.mybatis.TextSqlNode;
...
public class BoundSql {
  ...
  private static final List<String> MYBATIS_TAGS =
      Arrays.asList("</where>", "</if>", "</trim>", "</set>", "</foreach>");
  ...
  private void normal(Map<String, Object> varMap) {
    ...
    this.sqlOrXml =
        this.sqlOrXml == null
            ? null
            : REPLACE_MULTI_WHITE_LINE.matcher(this.sqlOrXml.trim()).replaceAll("\r\n");
  }
        ...
        () -> {
          ...
          try {
            ...
            interceptors.forEach(
                interceptor -> interceptor.handleException(this, e, requestEntity));
            throw e;
          }
          return (T) result;
        };
