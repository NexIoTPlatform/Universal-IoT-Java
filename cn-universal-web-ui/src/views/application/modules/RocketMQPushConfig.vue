  ...
  <div class="protocol-config">
      ...
      <template v-else-if="config.enable">
        <div class="config-item">
          ...
          <div class="config-value">
            <div class="config-input">
              <span class="url-text">{{ rocketMQConfig.namesrvAddr }}</span>
              <div class="config-actions">
                <a-tooltip title="复制地址">
                  <a-button
                    type="link"
                    size="small"
                    @click="copyToClipboard(rocketMQConfig.namesrvAddr)"
                    class="action-btn"
                  >
                    <a-icon type="copy"/>
                  </a-button>
        ...
        <div class="config-item">
          ...
          <div class="config-value">
            <div class="config-input">
              <span class="topic-text">{{ rocketMQConfig.topic }}</span>
              <div class="config-actions">
                <a-tooltip title="复制Topic">
                  <a-button
                    type="link"
                    size="small"
                    @click="copyToClipboard(rocketMQConfig.topic)"
                    class="action-btn"
                  >
                    <a-icon type="copy"/>
                  </a-button>
        ...
        <div class="config-item">
          ...
          <div class="config-value">
            <div class="config-input">
              <span class="group-text">{{ rocketMQConfig.group }}</span>
              <div class="config-actions">
                <a-tooltip title="复制消费者组">
                  <a-button
                    type="link"
                    size="small"
                    @click="copyToClipboard(rocketMQConfig.group)"
                    class="action-btn"
                  >
                    <a-icon type="copy"/>
                  </a-button>
