                ...
                <div class="product-layout">
                  ...
                  <div class="product-left-section">
                    ...
                    <div class="product-details-left">
                      ...
                      <div class="detail-item" v-if="productDetails.creatorId === $store.state.user.name || $store.state.user.currentAdmin">
                      ...
                      <div class="detail-item" v-if="productDetails.storePolicy">
                        ...
                        <span class="detail-value">{{ productDetails.storePolicy || '-' }}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="product-right-section">
                    <div class="product-image-section">
                      ...
                      <div class="image-actions">
                        ...
                        >
                          <a class="action-link">
                            <a-icon type="upload"/> {{ productImageUrl ? '更换' : '上传' }}
                          </a>
                        </a-upload>
                      </div>
                    </div>
