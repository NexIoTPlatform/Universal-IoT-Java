        ...
        <div class="connection-mode-description">
          <div class="mode-item">
            ...
            <div class="mode-info">
              ...
              <div class="mode-desc">通过{{ getPlatformTitle() }}服务端组件连接，需配置允许连接的IP地址和端口，设备连接到服务端</div>
            </div>
          </div>
          <div class="mode-item" v-if="product.thirdPlatform === 'tcp'">
            ...
            <div class="mode-info">
              ...
              <div class="mode-desc">使用TLS SNI方式，域名格式为：productKey.tcp.nexiot.xyz:38883，支持加密传输，所有TCP产品均默认支持该方式连接</div>
            </div>
          </div>
        </div>
      </div>
...
import {updateProductNetworkUnionId, getProductConnectInfo} from '@/api/system/dev/product'
