  ...
  <div class="tcp-detail-page minimal">
          ...
          <template v-else>
            <a-form :model="formData" layout="horizontal" label-col="{ style: { width: '120px' } }"
              ...
              <div style="margin-top:16px;text-align:right;">
                <a-button type="link" size="small" v-hasPermi="['network:tcp:edit']" @click="handleSaveConfig">保存</a-button>
    ...
    <a-modal v-model="previewVisible" title="请确认即将提交的配置JSON" :footer="null" width="600px">
      ...
      <div style="text-align:right;margin-top:16px;">
        ...
        <a-button type="primary" style="margin-left:8px;" v-hasPermi="['network:tcp:edit']" @click="confirmSaveConfig">确认提交
        </a-button>
      </div>
    </a-modal>
  </div>
