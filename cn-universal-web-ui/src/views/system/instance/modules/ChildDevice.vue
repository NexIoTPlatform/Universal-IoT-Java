    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="48">
          ...
          <a-col :md="8" :sm="24">
            <a-form-item :label="$t('device.name')" prop="deviceName">
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        {
          title: this.$t('device.deviceSerial'),
          dataIndex: 'deviceId',
          ellipsis: true,
        ...
        {
          title: this.$t('device.lastCommunicationTime'),
  ...
  filters: {},
  created() {
    console.log('ChildDevice created - devId:', this.devId)
    console.log('ChildDevice created - gwProductKey:', this.gwProductKey)
    this.getList()
  ...
  methods: {
    ...
    getList() {
      ...
      this.queryParam.extDeviceId = this.extDeviceId
