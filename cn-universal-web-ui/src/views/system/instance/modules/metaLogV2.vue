    ...
    trendNumChanged(val) {
      ...
      this.timer = setTimeout(() => {
        ...
        if (val === 1) {
          ...
          this.queryParams.beginCreateTime = this.createTimeRange[0].format('YYYY-MM-DD HH:mm:ss')
          this.queryParams.endCreateTime = this.createTimeRange[1].format('YYYY-MM-DD HH:mm:ss')
          params.beginCreateTime = this.createTimeRange[0].format('YYYY-MM-DD HH:mm:ss')
          params.endCreateTime = this.createTimeRange[1].format('YYYY-MM-DD HH:mm:ss')
        }
