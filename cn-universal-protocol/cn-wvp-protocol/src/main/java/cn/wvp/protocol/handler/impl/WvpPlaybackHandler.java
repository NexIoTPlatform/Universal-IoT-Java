...
@Component
public class WvpPlaybackHandler implements WvpCommandHandler {
  @Resource private WvpDeviceService wvpDeviceService;

  public R<?> handle(WvpDownRequest request) {
    return wvpDeviceService.startPlayback(request);
  }
  public String getSupportedCommand() { return CameraCommand.CAMERA_PLAYBACK.getFunctionName(); }
}
