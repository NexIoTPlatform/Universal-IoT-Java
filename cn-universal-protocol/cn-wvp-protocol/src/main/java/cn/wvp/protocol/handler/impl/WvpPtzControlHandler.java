...
@Component
public class WvpPtzControlHandler implements WvpCommandHandler {
  @Resource private WvpDeviceService wvpDeviceService;

  public R<?> handle(WvpDownRequest request) {
    return wvpDeviceService.ptzControl(request);
  }
  public String getSupportedCommand() { return CameraCommand.CAMERA_TURN.getFunctionName(); }
}
