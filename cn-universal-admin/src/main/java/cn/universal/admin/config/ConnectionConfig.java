...
public class ConnectionConfig {
    ...
    // 默认主题模板常量
    private static final String DEFAULT_THING_PROPERTY_UP = "$thing/up/property/{productKey}/{deviceId}";
    ...
    private static final String DEFAULT_PASSTHROUGH_COMMAND_DOWN = "$thing/down/{productKey}/{deviceId}";
    ...
    public String getMqttPassthroughCommandDown() {
        return mqttPassthroughCommandDown.isEmpty() ? DEFAULT_PASSTHROUGH_COMMAND_DOWN : mqttPassthroughCommandDown;
    }
}