...
- **🚀 WVP视频平集成**：与WVP视频平台系列集成 `（202512月已完成）`
- **🚀 大华ICC系列产品**：与大华ICC产品系列集成`（无环境，延期中）`
- **🚀 海康综合安防管理平台**：使用海康平台产品系列集成`（无环境，延期中）`
- **📱 移动端应用**：付费图鸟定小程序，具备指令控制、属性、告警查看，轻量化、多管理员`（进行中）`
...
- [x] 多协议接入：任意 TCP 协议、任意 MQTT Topic主题和消息、HTTP 接入，支持粘包/分包、读写超时、解析器类型全部页面可配和扩展
...
|                                         |                                           |                                          |                                         |
|-----------------------------------------|-------------------------------------------|------------------------------------------|-----------------------------------------|
| ![小程序](/__MACOSX/shot/1217/01-shou.jpg) | ![app](__MACOSX/shot/1217/02-tianjia.jpg) | ![app](__MACOSX/shot/1217/03-detail.jpg) | ![app](__MACOSX/shot/1217/04-trade.jpg) |
