...
| **数据桥接**        | 支持数据源配置、支持桥接规则定义设置</br>支持桥接类型输入、输出、双向数据</br>直接输出写入（Mysql、PostgreSQL、SqlServer、Oracle）数据库</br>支持时序数据库输出（IoTDB、Clickhouse、InfluxDB）</br>支持消息对接MQ输出（Kafka、MQTT）</br>支持HTTP数据桥接</br>支持其他中间件扩展 | ✅ | ✅ |
...
| **社区免费驱动**      | 得力于优异的架构设计，社区已对接的驱动可直接导出免费使用</br>已支持DLT645-2007、JT808、天翼物联50余种设备</br>                                                                                                                     | ✅ | ✅ |
...
|微信                            | B站                              | 抖音                               |
|-------------------------------|---------------------------------|----------------------------------|
|  ![微信](/__MACOSX/shot/wx.png) | ![B站](/__MACOSX/shot/bzhan.jpg) | ![抖音](/__MACOSX/shot/douyin.jpg) |
