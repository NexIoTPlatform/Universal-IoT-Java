...
```
#### 演示环境情况
演示环境是最新代码，是一个集群的部署情况（TCP、MQTT）,有希望在演示环境做对接测试验证的，请提前私信，我尽力提高最大的技术支持。
...
开源版本采用AGPL3协议，可用于个人学习和使用，商业用途需赞助项目，获得授权。
...
开源版本暂不包含TCP、天翼物联ctaiot模块。可自行二次开发扩展，商用授权需获取授权。

### 参考项目

感谢若依、Antdv、jetlink、ssssssss-team 开源软件，阿里云、华为云、腾讯云、AEP和OneNet等物联网平台