...
import cn.universal.common.exception.FileNameLengthLimitExceededException;
import cn.universal.common.exception.FileSizeLimitExceededException;
import cn.universal.common.exception.InvalidExtensionException;
import java.io.File;
...
public class FileUploadUtils {
  ...
  public static final String getPathFileName(String uploadDir, String fileName) throws IOException {
    int dirLastIndex = UnivUPloadConfig.getProfile().length() + 1;
