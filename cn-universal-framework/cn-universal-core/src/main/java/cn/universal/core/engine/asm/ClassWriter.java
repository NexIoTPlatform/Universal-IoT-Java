 ...
 * modified class from one or more existing Java classes. @Author Eric Bruneton
 *
...
public class ClassWriter extends ClassVisitor {
  ...
  public final void visitInnerClass(
    ...
    // which represents a class or processer C that is not a package member must have exactly one
  ...
  public byte[] toByteArray() {
    ...
    // methods_count and attributes_count) use 2 bytes each, and each processer uses 2 bytes too.
