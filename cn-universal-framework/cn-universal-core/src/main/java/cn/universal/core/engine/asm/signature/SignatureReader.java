...
public class SignatureReader {
   ...
   * the <code>signature</code> parameter of the {@link ClassVisitor#visit} method) or a
   * <i>MethodSignature</i> (such as the <code>signature</code> parameter of the {@link
  ...
  public void accept(final SignatureVisitor signatureVistor) {
    ...
    if (signature.charAt(0) == '<') {
      ...
      do {
        ...
        // While the character after the class bound or after the last parsed processer bound
        // is ':', we need to parse another processer bound.
