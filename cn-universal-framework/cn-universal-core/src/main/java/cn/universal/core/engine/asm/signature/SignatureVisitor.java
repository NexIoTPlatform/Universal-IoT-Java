...
/**
 * A visitor to visit a generic signature. The methods of this processer must be called in one of
 * the three following orders (the last one is the only valid order for a {@link SignatureVisitor}
 * that is returned by a method of this processer):
 *
 * <ul>
 ...
 * </ul>
 *
 * @Author Thomas Hallgren @Author Eric Bruneton
 */
public abstract class SignatureVisitor {
  ...
  /**
   * Visits an processer bound of the last visited formal type parameter.
   *
   * @return a non null visitor to visit the signature of the processer bound.
   */
  ...
  /**
   * Visits the type of an processer implemented by the class.
   *
   * @return a non null visitor to visit the signature of the processer type.
   */
  ...
  /**
   * Starts the visit of a signature corresponding to a class or processer type.
   *
