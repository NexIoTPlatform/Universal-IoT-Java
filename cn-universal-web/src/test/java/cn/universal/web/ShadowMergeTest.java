    ...
    private String mergeShadowJson(String existingJson, String incomingJson) {
        ...
        try {
            ...
            if (tsExisting != null || tsIncoming != null) {
                long maxTs = Math.max(tsExisting == null ? 0L : tsExisting, tsIncoming == null ? 0L : tsIncoming);
        ...
        try {
            ...
            if (verExisting != null || verIncoming != null) {
                long maxVer = Math.max(verExisting == null ? 0L : verExisting, verIncoming == null ? 0L : verIncoming);
